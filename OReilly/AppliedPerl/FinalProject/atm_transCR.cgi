...
my $message = "Enter the amount you wish to withdraw";
...
This program handles the initial input for a user who wants to withdraw money
from their account. The user to enters the dollar amount they wish
to withdraw and presses the "submit" button. The process to handle the
transaction of the withdrawl is passed to "atm_process_transact.cgi".
...
account number, the type of transaction (credit) & the amount to be withdrawn.
